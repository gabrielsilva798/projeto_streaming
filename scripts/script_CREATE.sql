...
-- um cliente pode ter vários perfis, porem somente 3 tipos de perfil
...
-- posso ter um cartão registrado, mas não usar ele (A PRINCIPIO)
...
-- se tipo pagamento <> 1, entao id_cartao_credito = NULL
